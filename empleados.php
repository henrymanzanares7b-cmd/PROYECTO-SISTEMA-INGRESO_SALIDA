...
if(isset($_POST['agregar'])) {
    ...
    $sql_insert = "INSERT INTO empleados (id_empleado, nombre_completo, puesto) VALUES ('$id', '$nombre', '$puesto')";
...
if(isset($_GET['eliminar'])) {
    ...
    $sql_delete = "DELETE FROM empleados WHERE id_empleado = '$id_eliminar'";
                        ...
                        <table class="table table-striped table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                while($fila = mysqli_fetch_assoc($resultado)) {
                                    echo "<tr>";
                                    echo "<td><b>" . $fila['id_empleado'] . "</b></td>";
                                    echo "<td>" . $fila['nombre_completo'] . "</td>";
                                    echo "<td>" . $fila['puesto'] . "</td>";
                                    echo "<td><span class='badge bg-success'>" . $fila['estado'] . "</span></td>";
                                    echo "<td><a href='empleados.php?eliminar=" . $fila['id_empleado'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"¿Borrar empleado?\")'><i class='bi bi-trash'></i></a></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
